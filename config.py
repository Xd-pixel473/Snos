CHANNEL_ID = -1002206312680 #канал для логов  

CHANNELS = {
    -1002269676734: "https://t.me/dbdhdhndj"
} # канали для подписки id:ссылка

api_id = '27729626'
api_hash = '8bfc014b67b5fa22cf8345fdc4196f44'
SESSION_DIR = '/storage/emulated/0/Download/session'
bot_token = '7873853381:AAHg_tJMmfPdCRnud-UhkIWFTMiUCSUmBZE' # Тут токен бота 
admin_chat_ids = ['7950944495']  # Добавьте сюда ID всех администраторов 'id', 'id' и тд
CRYPTO_PAY_TOKEN = '350226:AAzrQ1LXWihfmDCQfISP5PjH7IqFkWxTuIa' # тут замените на свой api от бота @send
